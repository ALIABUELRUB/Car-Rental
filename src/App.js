...
const asyncCarsListContainer = React.lazy(() => import('./components/CarsList/CarsListContainer'));
...
const asyncCarDetails = React.lazy(() => import('./components/CarDetails/CarDetails'));
...
class App extends Component {
  ...
  componentDidUpdate = () => {
    ...
    if (localStorage.getItem("token") !== null && localStorage.getItem("imgName") !== null) {
      ...
      routes = (
        <Navigationbar>
          <Switch>
            ...
            <Route path="/User/CarsList/CarDetails" exact component={asyncCarDetails} />
