        ...
        get('/CarsList.json', queryParams)
            .then(res => {
                ...
                Object.keys(res.data).map(data => {
                    ...
                    put(`/CarsList/${data}/carDetails/horsePower.json`, `"${newHorsePower}"` )
                        .then(res => {
                            console.log(res)
        ...
        get('/CarsList.json', queryParams)
            .then(res => {
                Object.values(res.data).map(data => {
                    ...
                    ///////////////////////////////////////////////
                    const exteriorImagesFileName = Object.values(data.ExteriorImages).map((data) => {
                        storage.ref('exteriorImages').child(data).getDownloadURL().then(url => {
                    ...
                    ///////////////////////////////////////////////
                    const interiorImagesFileName = Object.values(data.InteriorImages).map((data) => {
                        storage.ref('interiorImages').child(data).getDownloadURL().then(url => {
