...
class CarDetails extends Component {
  ...
  componentWillMount = () => {
    if (
      localStorage.getItem('refreshCarDetailsPage') !== 'true' &&
      this.props.location.aboutProps !== null
    ) {
      localStorage.setItem(
        'class',
        this.props.location.aboutProps.car.carDetails.class
      )
      localStorage.setItem(
        'engine',
        this.props.location.aboutProps.car.carDetails.engine
      )
      localStorage.setItem(
        'horsePower',
        this.props.location.aboutProps.car.carDetails.horsePower
      )
      localStorage.setItem(
        'bodyType',
        this.props.location.aboutProps.car.carDetails.bodyType
      )
      localStorage.setItem('refreshCarDetailsPage', 'true')
      localStorage.setItem(
        'disabled',
        this.props.location.aboutProps.car.disabled
      )
    }
  }
  ...
  componentDidMount = () => {
    if (this.props.location.aboutProps != null) {
      localStorage.setItem(
        'aboutProps',
        JSON.stringify(this.props.location.aboutProps)
      )
    }
      ...
      <Aux>
        <div className="container mt-2">
          ...
          {localStorage.getItem('isAdmin') !== 'false' ? (
            <EditCar disabled={localStorage.getItem('disabled')} />
          ) : null}
          ...
          {localStorage.getItem('isAdmin') === 'false' ? (
            <Rent
              ...
              pricePerday={retrievedObject.car.PricePerday}
            />
          ) : null}
          <p
            style={{
          ...
          >
            <button
              onClick={() => this.toggleModalImages('exterior')}
              style={{
                border: 'none',
          ...
          <div className="col text-center">
            ...
            <button
              onClick={() => this.toggleModalImages('interior')}
              style={{
                outline: 'none',
                border: 'none',
                backgroundColor: 'white',
          ...
          >
              ...
              <ButtonToolbar>
                <ToggleButtonGroup type="radio" name="options" defaultValue={x}>
                  <ToggleButton
                    ...
                    variant="dark"
                    value={1}
                    onClick={this.exteriorImagesIsClicked}
                  >
                    Exterior
                  </ToggleButton>
                  ...
                  <ToggleButton
                    ...
                    variant="dark"
                    value={2}
                    onClick={this.interiorImagesIsClicked}
                  >
                    Interior
                  </ToggleButton>
                </ToggleButtonGroup>
            ...
            <ModalBody>{show}</ModalBody>
          </Modal>

          <hr
            style={{ backgroundColor: 'black', opacity: '.5', width: '81%' }}
          />
          <h3 style={{ textDecoration: 'underline', marginTop: '7px' }}>
            Details:
          </h3>

          <ul>
            <li style={{ listStyle: 'none' }}>
              <p style={{ opacity: '0.7', display: 'inline' }}> Engine: </p>
              <span>
            ...
            <li style={{ listStyle: 'none' }}>
              ...
              <span>
                <strong className="text-capitalize">
                  {localStorage.getItem('horsePower')}
                </strong>
              </span>
            </li>

            <li style={{ listStyle: 'none' }}>
              <p style={{ opacity: '0.7', display: 'inline' }}> Class: </p>
              <span>
                <strong className="text-capitalize">
            ...
            <li style={{ listStyle: 'none' }}>
              <p style={{ opacity: '0.7', display: 'inline' }}> Body Type: </p>
              <span>
                <strong className="text-capitalize">
...
const mapDispatchToProps = dispatch => {
  return {
    onExteriorImages: exteriorImages =>
      dispatch(carDetailsActions.exteriorImages(exteriorImages)),
    onInteriorImages: interiorImages =>
      dispatch(carDetailsActions.interiorImages(interiorImages)),
  }
}
