  ...
  render() {
    return (
      <div>
          ...
          message={
            <span id="message-id">
              <div>
                <img
                  src={
                    this.props.snackbarMsg === 'Deleted successfully'
                      ? ThickMark
                      : FailedMark
                  }
                  alt={this.props.altSnackBarImg}
                  width="20px"
                  height="20px"
                />
        ...
        {/* /////////////////////////////////////////// */}
        <Modal
          isOpen={this.props.deleteCarModalIsOpen}
          className="modal-dialog-centered"
          toggle={this.props.deleteCarToggleModal}
        >
          <ModalHeader
          ...
          <ModalFooter>
            ...
            <div>
              <button
                ...
                disabled={this.props.isLoadingButtonSpinner}
              >
                {this.props.isLoadingButtonSpinner && (
        ...
        <button
          className={['btn btn-danger', classes.deleteCar].join(' ')}
          onClick={this.props.onDeleteCarToggleModal}
        >
          DELETE
        </button>
...
const mapDispatchToProps = dispatch => {
  return {
    ...
    onDeleteCarToggleModal: () =>
      dispatch(deleteCarActions.deleteCarToggleModal()),
  }
}
