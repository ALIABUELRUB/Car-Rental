...
class CarsList extends Component {
    ...
    handleAddNewCar = () => {
        ...
        if (this.state.carName === '') {
            ...
            axios.post('/CarsList.json?auth=' + this.props.token, newCar)
                .then(res => {
                    ...
                    localStorage.setItem("NoOfCars", parseInt(localStorage.getItem("NoOfCars")) + 1)
    ...
    handleRetrieve = (carID, carName, pricePerday, exteriorImages, interiorImages, disabled, carDetails) => {
        ...
        if (!disabled) {
                ...
                <button style={{ backgroundColor: "transparent", border: "none", outline: "none" }}
                    ...
                    <div className={" bg-white text-black"}>
                        <div
                            ...
                            <img src={this.state.url || "https://via.placeholder.com/70x70"}
                                alt="Rental Car" width="70px" height="70px" />
                            <p className="card-text" style={{ opacity: 0.5, textTransform: 'capitalize' }}>{carName}</p>
                            <hr />
                            <p>{pricePerday}$/DAY</p>
            ...
            return (
                <button style={{ backgroundColor: "transparent", border: "none", outline: "none" }} key={carID} disabled>
                    <div className={" bg-white text-black"}>
                        <div
    ...
    componentDidMount = () => {
        ...
        axios.get('/CarsList.json?auth=' + this.props.token)
            .then(response => {
                ...
                Object.values(response.data).map((data, i) => {
                    ...
                    storage.ref('carImages/').child(data.ImgName).getDownloadURL().then(url => {

                        this.setState({ url: url })
                        carList = this.handleRetrieve(
                            data.CarID, data.CarName, data.PricePerday,
                            data.ExteriorImages, data.InteriorImages, data.disabled, data.carDetails)
    ...
    render() {
        ...
        return (
            ...
            <div>
                ...
                <Modal isOpen={this.state.addNewCarModalIsOpen}

                    className="modal-dialog-centered" toggle={this.addNewCarToggleModal}>
                    <ModalHeader toggle={this.addCarToggleModal}
                        style={{ borderBottom: "0.5px solid rgba(169, 169, 169, .5)" }}
                        cssModule={{ 'modal-title': 'w-100 text-center' }}>

                        <p className="modal-title" style={{ fontSize: "30px", textDecoration: "underline" }}>
                            Add New Car</p>

                    </ModalHeader>

                    <ModalBody className="container" style={{ overflowY: "scroll", height: "200px" }}>
                        ...
                        <input type="text" id="carName" onChange={this.handleChange}
                            style={{
                                border: "2px solid gray", borderRadius: "10px", padding: "3px",
                                marginTop: "-7px", outline: "none"
                            }} required />

                        <label style={{ display: "block", marginTop: "10px" }}>Cost Per Day:</label>
                        <input type="text" id="costPerDay" onChange={this.handleChange}
                            style={{
                                border: "2px solid gray", borderRadius: "10px", padding: "3px",
                                marginTop: "-7px", outline: "none"
                            }} required />
                        ...
                        <label style={{ display: "block", marginTop: "10px" }}>Car Image:</label>
                        <input type="file" id="carImageName" onChange={this.handleChangeImg}
                            style={{ marginTop: "-1px", display: "block" }} required />

                        <label style={{ display: "block", marginTop: "20px" }}>Engine:</label>
                        <input type="text" id="engine" onChange={this.handleChange}
                            style={{
                                border: "2px solid gray", borderRadius: "10px", padding: "3px",
                                marginTop: "-7px", outline: "none"
                            }} required />

                        <label style={{ display: "block", marginTop: "20px" }}>Horse Power:</label>
                        <input type="text" id="horsePower" onChange={this.handleChange}
                            style={{
                                border: "2px solid gray", borderRadius: "10px", padding: "3px",
                                marginTop: "-7px", outline: "none"
                            }} required />

                        <label style={{ display: "block", marginTop: "20px" }}>Class:</label>
                        ...
                        <label style={{ display: "block", marginTop: "20px" }}>Body Type:</label>
                        <input type="text" id="bodyType" onChange={this.handleChange}
                            style={{
                                border: "2px solid gray", borderRadius: "10px", padding: "3px",
                                marginTop: "-7px", outline: "none", display: "block"
                            }} required />
                        ...
                        <button onClick={(e) => this.addNewInteriorImageFile(e)}
                            className="btn btn-outline-dark" style={{ marginTop: "5px" }}>
                            AddNewInteriorImageFile</button>
                    ...
                    <ModalFooter>
                        ...
                        <button className="btn btn-outline-primary"
                            onClick={this.addNewCarToggleModal} >Cancel</button>

                        <div >
                            <Button color="primary" onClick={this.handleAddNewCar} disabled={this.state.isLoadingButtonSpinner}>
                                {this.state.isLoadingButtonSpinner && <i className="spinner-grow spinner-grow-sm" role="status"></i>}
                ...
                {this.props.admin === "admin" ? <input type="image" title="Add new car"
                    className={classes.inputImage} onClick={this.addNewCarToggleModal}
                    src={addCarLogo} alt="Add New Car" /> : null}
                ...
                <div style={{ margin: style }} className={classes.divMargin} >
                    ...
                    <h4 style={{
                        ...
                        fontSize: '15px', marginLeft: "21px", clear: "both"
                    }}>
                        Cars List </h4>
