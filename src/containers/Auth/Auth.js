                ...
                <form onSubmit={this.handleSubmit}>
                    <div className={"input-group form-group"}>
                        <div className={classes.InputGroupPrepend}>
                            <span className={"input-group-text"}><img src={UserNameIcon} alt="userIcon"
                                width="90%" /></span>
                        </div>
                    ...
                    <div className={"input-group form-group"}>
                        <div className={classes.InputGroupPrepend}>
                            <span className={"input-group-text"}><img src={passwordIcon} alt="passwordIcon"
                                width="100%" /></span>
                        </div>
                    ...
                    <div className={[classes.remember, "row align-items-center"].join(" ")}>

                    </div>
                    <div className={"form-group"}>
                        <button className={[classes.loginBtn, "btn btn-warning", "float-right"].join(" ")} disabled={this.props.loading}>
                             Login</button>
                    </div>
                </form>
            ...
            <div >
                ...
                <Navbar bg="dark" expand="sm" style={{ height: "65px" }}>
                    ...
                    <Navbar.Collapse id="basic-navbar-nav"
                        style={{ backgroundColor: "transparent" }} className={classes.zIndex}>
