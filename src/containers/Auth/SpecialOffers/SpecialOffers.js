...
const specialOffers = () => (
    ...
    <div className="container my-4 mr-9" >
        ...
        <h4 style={{
            color: "gray",
            textDecoration: "underline", textAlign: "left", marginLeft: "50px"
        }}>
            Special Offers</h4>
        ...
        <div className="row ">
            ...
            <div className="col-lg-3 col-md-10 ml-5 mb-4">
                ...
                >
                    <div className={classes.container}>
                        <img src={Honda} className="img-fluid mb-4" alt=""
                            data-wow-delay="0.2s" />
                ...
                <Carousel showArrows={false} showThumbs={false} showStatus={false} width="100%"
                    dynamicHeight stopOnHover={true} transitionTime={2000} interval={7000}
                    showIndicators={false}
                >
                    <div className={classes.container}>
                        <img src={Volkswagen} className="img-fluid mb-4" alt=""
                            data-wow-delay="0.2s" />
                        <div className={[classes.textBlock].join(" ")}>
                            <div className={classes.TopLeft}>
                                <p>from $60 per day</p>
            ...
            <div className="col-lg-5 col-md-10 ml-5 mt-3">
                ...
                >
                    ...
                    <div className={classes.containerCarousel}>
                        <img src={FamilyCar} className="img-fluid mb-4" alt=""
                            data-wow-delay="0.5s" />
                        <div className={[classes.textBlockCarousel].join(" ")}>
                            <div className={classes.TopLeftCarousel}>
                    ...
                    <div className={classes.containerCarousel}>
                        <img src={LuxuryCar} className="img-fluid mb-4" alt=""
                            data-wow-delay="0.5s" />
                        <div className={[classes.textBlockCarousel].join(" ")}>
                            <div className={classes.TopLeftCarousel}>
